- dashboard: core_stats__overall__display
  title: Core Stats - Overall - Display
  layout: newspaper
  elements:
  - name: Display - In-market Timing (By ~ Spend/Day)
    title: Display - In-market Timing (By ~ Spend/Day)
